...
public class AlexaLaunchListenerProcessorTest {
    @Test
    ...
    public void processValid() throws Exception {
        final JavaFileObject fileObject = JavaFileObjects.forResource("handler/ValidLaunchHandler.java");
        assertAbout(javaSource())
                .that(fileObject)
                .processedWith(new AlexaLaunchListenerProcessor())
